...
/*CREATE TABLE fin.ExpenseCategories (
...
/*CREATE TABLE fin.Expenses (
    ...
    FOREIGN KEY (category_id) REFERENCES fin.ExpenseCategories(category_id)
);*/
...
/*INSERT INTO fin.Users (user_id, username, password, email) VALUES  
...
/*INSERT INTO fin.ExpenseCategories (category_id, category_name) VALUES  
(1, 'Groceries'),  
(2, 'Public Transport'),  
(3, 'Electricity & Water'),  
(4, 'Movies & Dining'),  
...
/*INSERT INTO fin.Expenses (expense_id, user_id, amount, category_id, date, description) VALUES  
...
--SELECT * FROM fin.ExpenseCategories;
--SELECT * FROM fin.Expenses;